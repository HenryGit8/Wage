/**
 * EmpMonSalHandler.java 2017/12/29 14:48
 ...
 * @version 1.0
 */
public interface EmpMonSalHandler {
     ...
     * @author 何友池
     */
    void updateWelfareData(Integer empId);
    /**
     * 批量更新福利表数据到其他工资表中
     * @param list
     * @author 何友池
     */
    void updateWelfareDataList(List<Integer> list);
    /**
     * 更新所有当月福利表数据到其他工资表中
     * @author 何友池
     */
    void updateAllDataList();
    /**
